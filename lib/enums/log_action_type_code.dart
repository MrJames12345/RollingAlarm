...
extension LogActionTypeCodeDisplay on LogActionTypeCodeEnum {
  ...
  Color get color => switch (this) {
    LogActionTypeCodeEnum.Dismiss => RA_ColourStyles.softCoral,
    LogActionTypeCodeEnum.Snooze => RA_ColourStyles.secondary,
    LogActionTypeCodeEnum.Skip => RA_ColourStyles.primary,
    LogActionTypeCodeEnum.AutoSnooze => RA_ColourStyles.sleepIndigo,
  ...
  List<BoxShadow>? get tileGlow => switch (this) {
    LogActionTypeCodeEnum.Snooze => RA_ShapeStyles.tealGlow,
    LogActionTypeCodeEnum.Dismiss => RA_ShapeStyles.softCoralGlow,
    _ => null,
  };
}
